 ...
 *
 *  $Id: IIOP_Connection_Handler.h 92070 2010-09-28 12:15:24Z johnnyw $
 *
...
typedef TAO_TCP_Connection_Service_Handler<ACE_SOCK_STREAM, ACE_NULL_SYNCH>
        TAO_IIOP_SVC_HANDLER;

#if defined ACE_HAS_EXPLICIT_TEMPLATE_INSTANTIATION_EXPORT
template class TAO_Export TAO_TCP_Connection_Service_Handler<
