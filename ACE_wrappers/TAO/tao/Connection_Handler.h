 ...
 *
 *  $Id: Connection_Handler.h 93359 2011-02-11 11:33:12Z mcorino $
 *
...
class TAO_Export TAO_TCP_Connection_Handler : public TAO_Connection_Handler
{
public:
  TAO_TCP_Connection_Handler(TAO_ORB_Core* orb_core);

  virtual int
  get_local_addr(ACE_Addr& address) const = 0;

  virtual int
  get_remote_addr(ACE_Addr& address) const = 0;
};

#include <ace/Svc_Handler.h>

template <ACE_PEER_STREAM_1, ACE_SYNCH_DECL>
class TAO_Export TAO_TCP_Connection_Service_Handler :
  public TAO_TCP_Connection_Handler,
  public ACE_Svc_Handler<ACE_PEER_STREAM_2, ACE_SYNCH_USE>
{
public:
  TAO_TCP_Connection_Service_Handler(TAO_ORB_Core* orb_core,
    ACE_Thread_Manager* thr_mgr, ACE_Message_Queue<ACE_SYNCH_USE>* mq,
    ACE_Reactor* reactor);
