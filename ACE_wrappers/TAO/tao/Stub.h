...
public:
  ...
  TAO_Profile *profile_in_use_pre_inc (void);
  ...
  TAO_Profile *profile_in_use_ptr (void);
  ...
  */
  ...
  TAO_Profile *profile_in_use_ptr_i (void);
...
private:
  ...
  TAO_Profile *next_forward_profile_i (void);
