// -*- C++ -*-
//
// $Id: Stub.inl 96992 2013-04-11 18:07:48Z huangh $
...
TAO_Stub::profile_in_use_ptr_i (void)
{
  return this->profile_in_use_;
}

ACE_INLINE TAO_Profile *
TAO_Stub::profile_in_use_ptr (void)
{
...
ACE_INLINE TAO_Profile *
TAO_Stub::next_forward_profile_i (void)
{
...
ACE_INLINE CORBA::Boolean
TAO_Stub::next_profile_retry_i (void)
{
  if (TAO_debug_level > 5)
    {
      TAOLIB_DEBUG ((LM_DEBUG,
...
ACE_INLINE const TAO_MProfile *
TAO_Stub::forward_profiles_i (void) const
{
