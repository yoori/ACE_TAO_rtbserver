// $Id: IIOP_Current_Impl.cpp 96944 2013-03-30 09:43:50Z mcorino $
...
namespace TAO
{
  namespace Transport
  {
    ...
    IIOP_Current_Impl::handler (void)
    {
      ...
      TAO_TCP_Connection_Handler* iiop_ch =
        dynamic_cast <TAO_TCP_Connection_Handler*> (ch);
      if (iiop_ch == 0)
        throw NoContext ();
    ...
    IIOP_Current_Impl::id (void)
    {
      ...
      return ACE_Utils::truncate_cast<CORBA::Long> ((intptr_t)dynamic_cast<TAO_IIOP_Connection_Handler*>(this->handler ())->get_handle ());
#else
      throw ::CORBA::NO_IMPLEMENT ();
#endif
    }
    ...
    {
#if defined (TAO_HAS_IIOP) && (TAO_HAS_IIOP != 0)
      TAO_TCP_Connection_Handler *iiopch =
        this->handler ();

      ACE_INET_Addr a;
      iiopch->get_remote_addr (a);
