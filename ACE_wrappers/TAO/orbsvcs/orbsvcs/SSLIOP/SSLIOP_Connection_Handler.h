 ...
 *
 *  $Id: SSLIOP_Connection_Handler.h 95576 2012-02-29 09:39:18Z johnnyw $
 *
...
namespace TAO
{
  namespace SSLIOP
  {
    typedef TAO_TCP_Connection_Service_Handler<ACE_SSL_SOCK_Stream,
     ...
     * the Connector
     */
    class Connection_Handler : public SVC_HANDLER
    {
    public:
