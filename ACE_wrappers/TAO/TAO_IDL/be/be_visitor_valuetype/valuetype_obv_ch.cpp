 ...
 *
 *  $Id: valuetype_obv_ch.cpp 97151 2013-05-20 09:52:28Z sma $
 *
      ...
      if (!node->opt_accessor ())
        {
          if (node->custom ())
          {
            *os << be_nl << be_uidt_nl << "public:" << be_idt_nl;

            *os << "virtual void" << be_nl
                << "marshal (::CORBA::DataOutputStream *);" << be_nl_2;

            *os << "virtual void" << be_nl
                << "unmarshal (::CORBA::DataInputStream *);" << be_nl_2;
          }
