...
#else
  if (ACE_Handle_Set_Iterator(this->ready_set_.wr_mask_)() != ACE_INVALID_HANDLE)
    return 10240;
  if (ACE_Handle_Set_Iterator(this->ready_set_.ex_mask_)() != ACE_INVALID_HANDLE)
    return 10240;
  if (ACE_Handle_Set_Iterator(this->ready_set_.rd_mask_)() != ACE_INVALID_HANDLE)
    return 10240;
#endif
    {
